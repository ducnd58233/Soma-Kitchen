...
let searchCookingPostController = require('./controllers/searchCookingPostController');
/* ---------------------------------------------------- 
...
router.post('/', postCookingPostController);

router.put('/:_id', updateCookingPostController);

router.delete('/:_id', deleteCookingPostController);

router.get('/search', searchCookingPostController);
/* ----------------------------------------------------
                END: Router
---------------------------------------------------- */
