    		...
    		<>
			    <section className="section pt-5 pb-5 text-center bg-white">
			         <Container>
			            <Row>
			               <Col sm={12}>
			                  <h5 className="m-0">Operate food recipe ? <Link to="login">Join With Us</Link></h5>
			               </Col>
			            </Row>
			         </Container>
			    </section>
			         ...
			         <Container>
			            <Row>
			               <Col md={4} sm={12}>
			                  ...
			                  <p><Link className="text-info" to="register">Register now</Link> to get updates on <Link to="offers">Awesome Recipes</Link></p>
			                  <div className="app">
...
Footer.defaultProps = {
	...
	popularFood: [],
	copyrightText: '© Copyright 2020 Soma Kitchen. All Rights Reserved',
	madewithIconclassName: 'heart heart-icon text-danger',
	firstLinkText: 'Group 25',
	firstLink: "//github.com/ducnguyen2000/Soma-Kitchen"
}
