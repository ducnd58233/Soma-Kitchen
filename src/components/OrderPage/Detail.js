		            ...
		            <Row>
		               <Col md={12}>
		                  ...
		                  <Nav  id="pills-tab">
		                     ...
		                     <Nav.Item>
		                        <Nav.Link eventKey="third">Recipe Info</Nav.Link>
		                     </Nav.Item>
		                     <Nav.Item>
		        ...
		        <Container>
		            <Row>
							    ...
							    <Tab.Content className='h-100'>
						            ...
						            <Tab.Pane eventKey="third">
						            	<div id="restaurant-info" className="bg-white rounded shadow-sm p-4 mb-4">
			                              ...
			                              <h5 className="mb-4">Recipe Info</h5>
		               ...
		               <div className="bg-white rounded shadow-sm text-white mb-4 p-4 clearfix restaurant-detailed-earn-pts card-icon-overlap">
		                     ...
		                     <p className="mb-0">60% off on orders above $99 | Use coupon <span className="text-danger font-weight-bold">SOMA50</span></p>
