			  ...
			  <Modal.Body>
               ...
               <div className="form-row">
                  <Form.Group className="col-md-12">
                     ...
                     <Form.Control type="text" defaultValue="0985517099" placeholder="Enter Phone number" />
                  </Form.Group>
                  <Form.Group className="col-md-12">
                     <Form.Label>Email id</Form.Label>
                     <Form.Control type="text" defaultValue="pct881435@gmail.com" placeholder="Enter Email id
                        "/>
                  </Form.Group>
