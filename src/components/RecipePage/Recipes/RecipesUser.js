			            ...
			            <Row className="d-none-m">
			               <Col md={12}>
								  ...
								  <Dropdown.Menu className='dropdown-menu-right shadow-sm border-0'>
								    ...
								    <Dropdown.Item href="#/rating">Popular</Dropdown.Item>
								    <Dropdown.Item href="#/comment">Rating</Dropdown.Item>
								  </Dropdown.Menu>
								</Dropdown>
											...
											<div className="filters-card-header" id="headingOne">
												<h6 className="mb-0">
													<Accordion.Toggle as={Button} size='block' variant="link" className='text-left d-flex align-items-center p-0' eventKey="2">
														Skill <Icofont icon='arrow-down' className='ml-auto'/>
													</Accordion.Toggle>
												</h6>
											</div>
										    <Accordion.Collapse eventKey="2">
										      <div className="filters-card-body card-shop-filters">
											      <Form.Check 
											        ...
											        defaultChecked={true}
											        id='custom-cb15'
											        label={<React.Fragment>Beginner</React.Fragment>}
											      />
											      ...
											      <Form.Check 
											        ...
											        type='checkbox'
											        id='custom-cb16'
											        label={<React.Fragment>Intermediate </React.Fragment>}
											      />
												  <Form.Check 
											        custom
											        type='checkbox'
											        id='custom-cb17'
											        label={<React.Fragment>Advance </React.Fragment>}
											      />
			                                  </div>
										    </Accordion.Collapse>
			                            </div>
